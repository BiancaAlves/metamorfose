...
<head>
	...
	<link rel="stylesheet" href="node_modules/bootstrap-custom/css/bootstrap.css" media="all"> 
	<link rel="stylesheet" href="node_modules/font-awesome/css/font-awesome.min.css" media="all"> 
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="#">Divulgação no Facebook</a></li>
